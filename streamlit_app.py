...
# Contact Page
    ...
    - **Email**: [lebom.letsoalo@gmail.com](mailto:lebom.letsoaloe@gmail.com) 
    - **LinkedIn**: [Lebogang letsoalo](https://www.linkedin.com/in/lebogang-letsoalo-72909a1a8/)  
    - **GitHub**: [Lebo Letsoalo](https://github.com/LeboSwaratlhe)  
    """)
